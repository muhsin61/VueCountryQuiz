...
<div class="box">
    ...
    <div class="box-item">
      <h1 class="question"><img :src="this.$store.state.country[this.$store.state.countryrandom[this.$store.state.trueCtry]].flag" alt=""> Which country does this flag belong to?</h1>
...
export default {
    ...
    data() {
    return {
      src: this.$store.state.country[this.$store.state.countryrandom[this.$store.state.trueCtry]].flag,
    }
    },
    methods: {
    select(event,number){
